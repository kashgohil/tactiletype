          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setNewGoal({ ...newGoal, goalType: e.target.value as 'wpm' | 'accuracy' | 'consistency' | 'daily_tests' })}
              ...
              >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Target: {Number(goal.targetValue)}{getGoalUnit(goal.goalType)}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-3">
                  <div className="flex justify-between text-sm text-gray-600 dark:text-gray-400 mb-1">
                    <span>
                      Current: {Number(goal.currentValue)}{getGoalUnit(goal.goalType)}
                    </span>
                ...
                <div className="flex items-center justify-between text-sm">
                  <div>
                    {isAchieved ? (
                      ...
                      <span className="text-gray-600 dark:text-gray-400">No deadline</span>
                    )}
                  </div>
