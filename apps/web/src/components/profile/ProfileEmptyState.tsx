...
export const ProfileEmptyState: React.FC<ProfileEmptyStateProps> = ({ variant = 'no-tests' }) => {
  if (variant === 'login') {
    return (
  ...
  return (
    <Panel className="p-8 md:p-12 text-center">
      ...
      <h2 className="text-xl md:text-2xl font-semibold mb-2">Your progress home is ready</h2>
